...
class ValidateMatchType(IntEnum):
    ...
    PARTIAL_MATCH = 4      # Частичное совпадение (например, часть названия артиста или лейбла в других записях)
    PARTIAL_SYNONYM_MATCH = 5  # Частичное совпадение между синонимами проверяемой записи с синонимами остальных записей
